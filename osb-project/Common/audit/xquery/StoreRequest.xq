...
declare namespace xf = "http://tempuri.org/Common/audit/xquery/StoreRequest/";

declare function xf:StoreRequest($header as element(ns1:Header)?,
    $request as element(*)?,
