...
declare function xf:StudentModuleRegistrationChoice2($captureStudentModuleSubscription as element(ns1:CaptureStudentModuleSubscription))
    as element(ns0:StudentModuleChoice) {
        <ns0:StudentModuleChoice>
            <ns0:StudentModuleWithdrawlRequest xmlns:ns0="http://open.ac.uk/soa/Student/CaptureStudentModuleChoice" 
                ...
                <ns0:StudentModule>
                    <ns0:personalId>{ data($captureStudentModuleSubscription/ns1:ModuleCancellationEvent/ns1:personalId) }</ns0:personalId>
                    <ns0:presentationId>{ data($captureStudentModuleSubscription/ns1:ModuleCancellationEvent/ns1:presentationId) }</ns0:presentationId>
                    <ns0:productId>{ data($captureStudentModuleSubscription/ns1:ModuleCancellationEvent/ns1:productId) }</ns0:productId>
                </ns0:StudentModule>
            </ns0:StudentModuleWithdrawlRequest>
        </ns0:StudentModuleChoice>
};
